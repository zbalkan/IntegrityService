...
{
    /// <summary>
    ///     An ordered dictionary implementation with fixed size (default: 50). When maximum size is
    ///     reached, the first element is removed (FIFO).
    /// </summary>
    /// <typeparam name="TKey">
    ///     A non-null Type of keys
    /// </typeparam>
    ...
    {
        /// <summary>
        ///     Gets the maximum number of items in the
        ///     <see cref="FixedSizeDictionary{TKey, TValue}" />. Default is 50.
        /// </summary>
        ...
        /// </summary>
        /// <param name="size">
        ///     Maximum number of elements the dictionary will handle.
        /// </param>
